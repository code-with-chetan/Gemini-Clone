       ...
       <div className="flex-1 min-h-screen pb-[15vh] relative">
        ...
        <div className="max-w-[900px] m-auto">
            ...
            ?<>
                ...
                <p><span className="text-5xl font-bold bg-gradient-to-r from-blue-500 to-red-500 gradient-text-clip text-transparent">
                  Hello,Coder</span></p>
                <p>How can I help you Today?</p>
            </div>
            <div className="grid grid-cols-[repeat(auto-fill,minmax(180px,1fr))] gap-[15px] p-5">
                <div className="card">
                    <p className="para-div">Suggest beautiful places to see on an Upcoming road trip</p>
                ...
                <div className="card">
                    ...
                    <img src={assets.bulb_icon} alt="compass icon" className="div-icon"/>
                </div>
                <div className="card">
                    <p className="para-div">Suggest beautiful places which is visited on Nepal 
                        in cold season</p>
                    <img src={assets.message_icon} alt="compass icon" className="div-icon" />
                </div>
                <div className="card">
                    <p className="para-div">Suggest beautiful places to see on an Upcoming mountain trip.</p>
                    <img src={assets.code_icon} alt="compass icon" className="div-icon"/>
                </div>
            </div>
            </>
            : <div className="px-0 py-[5%] max-h-[70vh] overflow-y-scroll  hide-scrollbar">
                ...
                <div className="flex items-start gap-5">
                    ...
                    {
                        loading ? <div className="w-full flex flex-col gap-[10px]">
            ...
            <div className="absolute bottom-0 w-full max-w-[900px] px-0 py-5">
                <div className="flex items-center justify-between gap-5 bg-[#f0f4f9]
                 px-4 py-3 rounded-[50px]">
                    <input onChange={(e)=>setInput(e.target.value)} value={input}
                    className="flex-1 border-none outline-none text-[18px] p-[4px]"
