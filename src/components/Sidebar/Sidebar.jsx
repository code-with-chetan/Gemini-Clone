...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col justify-between min-h-screen bg-[#f0f4f9] px-[20px] py-[15px] max-[600px]:hidden">
      <div className="top">
        <img
        ...
        <div
          onClick={() => newChat()}
          className="mt-[50px] inline-flex items-center gap-[10px] px-[10px] py-[10px] bg-[#e6eaf1] rounded-full text-[14px] text-gray-600 cursor-pointer"
        >
